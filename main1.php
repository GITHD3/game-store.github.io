            ...
            <div class="row row-cols-2 g-3">
                <div class="col card-body">
                    <div class="card mb-3 bcard" style="max-width: 650px;">
                        <h6 class="card-title cardtitle2 text-center">Most Anticipated Game</h6>
                        <div class="row g-2">
...
.bcard {
    font-family: 'Nohemi', sans-serif;
    background-color: #a58fff !important; 
    backdrop-filter: blur(10px);
...
body {
    ...
    background:linear-gradient(#7a8ced,#4a6baa) !important ;
