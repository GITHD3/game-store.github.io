                    ...
                    <a href="seppage.php?gameName=MultiVersus" class="texta1card-a">
                        ...
                        <div class="image-container2">
                            ...
                            <div class="texta1card">
                                : Seizing the championship title at The Game Awards 2022, MultiVersus reigns supreme as
                                the
                                unrivaled victor in the fighting game arena, securing the esteemed accolade for Best
                                Fighting Game. It's not just a game; it's a triumph in every punch, a victory in every
                                move,
                        ...
                        <a href="seppage.php?gameName=Gord" class="texta1card-a">
                            <div class="image-container2">
                                ...
                                <div class="texta1card">
                                    : GORD Game: Evolving Beyond Limits! From release till now, updates have slain
                                    critics'
                        ...
                        <?php if ($age >= 18) {?>
                            ...
                            <?php }else ?>
                                <a href="#"
                                    onclick="alert('You must be 18 or older to access this content.'); return false;"> ?>
                                <div class="image-container2">
                                    <img class="a1card" src="img 2/Cyberpunk2077.webp" alt="Image">
                                    <div class="texta1card">
                                        : The upcoming expansion, Phantom Liberty, is set to be released on September
                                        26, 2023.
                                        It will add new quests, weapons, and enemies to the game.
                                        CD Projekt Red is also working on a sequel to Cyberpunk 2077, but it is still in
                                        the early
                            ...
                            <?php if ($age >= 18){ ?>
                                ...
                                <?php }else ?>
                                    ...
                                    <div class="image-container2">
                                        ...
                                        <div class="texta1card">GTA V is still the most-watched game on Twitch. In 2021,
                                            GTA V was the
                                            most-watched game on Twitch, with over 3.1 billion hours watched. This is
                                            likely due to the
                                            popularity of GTA RP, a mode where players join a dedicated GTA server and
                                            roleplay as
                                            different
                                            characters.</div>
                                    </div>
                ...
                <div class="row v1">
                    <div class="v1child">
                        ...
                        <p>Forza Horizon 5 breaks records with its vast 50% larger map than its predecessor. Dynamic
                            weather adds thrill to gameplay. Nominated for Game of the Year at The Game Awards 2021.
                                <a href="seppage.php?gameName=Froza Horizon 5"> Click For More!!</a>
                        </p>
                        <div class="timenews">
                    ...
                    <div class="v1child">
                        ...
                        <p>Wolfenstein: The New Order, where the Axis Powers reign after WWII. As B.J. Blazkowicz, lead
                            ...
                            week
                            <?php if ($age >= 18) {?>
                                <a href="seppage.php?gameName=Wolfenstein New Order"> Click For More!!</a>
                             <?php } else ?>
                                <a href="#"
                                    onclick="alert('You must be 18 or older to access this content.'); return false;"> Click
                                    For More!!</a>
                    ...
                    <div class="v1child">
                        ...
                        <p>Most Played Car Racing Game!
                                <a href="seppage.php?gameName=Need For Speed Most Wanted"> Click For More!!</a>
                        </p>
                        <div class="timenews">
                            <h6 class="b-0" style="color: grey;">
                    ...
                    <div class="v1child">
                        ...
                        <p>The Trails & Tales Update has been released, introducing new story elements, items, and
                            ...
                            diverse challenges.
                                <a href="seppage.php?gameName=Minecraft"> Click For More!!</a>
                        </p>
                        <div class="timenews">
                            <h6 class="b-0" style="color: grey;">
                                <text-muted><small>15 Days ago</small></text-muted>
                            </h6>
                        </div>
                    </div>
                    <div class="v1child">
                        ...
                        <p>PUBG Mobile's ban in India during September 2020, citing addiction and gambling concerns, was
                            lifted in March 2022. PUBG: New State arrives this November 2022, featuring dynamic gameplay
                            with drivable vehicles and advanced weapon attachments.
                            <?php if ($age >= 18){?>
                                <a href="seppage.php?gameName=PlayerUnknown's Battlegrounds"> Click For More!!</a>
                             <?php } else ?>
                                <a href="#"
                                    onclick="alert('You must be 18 or older to access this content.'); return false;"> Click
                                    For More!!</a>
                        ...
                        <div class="timenews">
                            <h6 class="b-0" style="color: grey;">
                                <text-muted><small>8 Months ago</small></text-muted>
                            </h6>
                        </div>
                    </div>
                    <div class="v1child">
                        ...
                        <p>It was the first Call of Duty game to be rated M for Mature by the ESRB. This was due to its
                            realistic violence and depictions of terrorism.
                            <?php if ($age >= 18){ ?>
                                <a href="seppage.php?gameName=Call Of Duty Modern Warfare"> Click For More!!</a>
                             <?php } else ?>
                                <a href="#"
                                    onclick="alert('You must be 18 or older to access this content.'); return false;"> Click
                                    For More!!</a>
                        ...
                        <div class="timenews">
                            <h6 class="b-0" style="color: grey;">
                                <text-muted><small>11 Days ago</small></text-muted>
                            </h6>
                        </div>
                    </div>
                    <div class="v1child">
                        ...
                        <p>Valorant boasts 15+ million monthly players, cementing its place as a premier competitive
                            ...
                            Episode 7 Act 3
                                <a href="seppage.php?gameName=Valorant"> Click For More!!</a>
                        </p>
                        <div class="timenews">
                            <h6 class="b-0" style="color: grey;">
                                <text-muted><small>19 Days ago</small></text-muted>
                            </h6>
                        </div>
                    </div>
                    <div class="v1child">
                        ...
                        <p>Escaping its True Crime beginnings, Sleeping Dogs triumphs anew with Square Enix after the
                            franchise's cancellation.
                            <?php if ($age >= 18){ ?>
                                <a href="seppage.php?gameName=Sleeping Dogs"> Click For More!!</a>
                             <?php } else ?>
                                <a href="#"
                                    onclick="alert('You must be 18 or older to access this content.'); return false;"> Click
                                    For More!!</a>
                        ...
                        <div class="timenews">
                            <h6 class="b-0" style="color: grey;">
                                <text-muted><small>20 Days ago</small></text-muted>
                            </h6>
                        </div>
                    </div>
                </div>
