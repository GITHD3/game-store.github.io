            ...
            <div class="col b1">
                <div class="row v1">
                    ...
                    <div class="v1child">
                        ...
                        <p>Most Played Car Racing Game! <a href="seppage.php?gameName=Need For Speed Most Wanted">Click For More!!</a></p>
                    </div>
                    <br>
                    <hr class="hrv1">
                    <div class="v1child">
                    ...
                    <div class="v1child">
                        ...
                        <p>It was the first Call of Duty game to be rated M for Mature by the ESRB. This was due to its
                            realistic violence and depictions of terrorism. <a href="seppage.php?gameName=Call Of Duty Modern Warfare">Click For More!!</a>
                        </p>
                    </div>
                    <br>
                    <hr class="hrv1">
