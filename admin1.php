...
<div class="flex">
    <div class="sidebard flex flex-col items-center w-16 pb-3 overflow-hidden text-indigo-300 bg-indigo-900 fixed right-0 top-0 rounded">
        <a class="flex items-center justify-center w-12 h-12 mt-2 rounded hover:bg-indigo-700" href="#">
            <svg class="w-6 h-6 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                <path d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 01-1.414 1.414L11 6.414V16a1 1 0 11-2 0V6.414L3.707 10.707a1 1 0 01-1.414-1.414l6-6z" />
            </svg>
        </a>
        <a class="flex items-center justify-center w-12 h-12 mt-2 rounded hover:bg-indigo-700" href="#">
            <svg class="w-6 h-6 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
        ...
        <a class="flex items-center justify-center w-12 h-12 mt-2 rounded hover:bg-indigo-700" href="#">
            <svg class="w-6 h-6 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                <path d="M6 1h9a2 2 0 012 2v14a2 2 0 01-2 2H6a2 2 0 01-2-2V3a2 2 0 012-2zm5 18a1 1 0 100-2 1 1 0 000 2zm-3-4a1 1 0 100-2 1 1 0 000 2zm0-4a1 1 0 100-2 1 1 0 000 2zm0-4a1 1 0 100-2 1 1 0 000 2z" />
            </svg>
        </a>
        ...
        <a class="flex items-center justify-center w-12 h-12 rounded hover:bg-indigo-700" href="#">
            <svg class="w-6 h-6 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                <path d="M14 7h2v2h-2zM14 11h2v2h-2zM14 15h2v2h-2zM10 7h2v2h-2zM10 11h2v2h-2zM10 15h2v2h-2zM6 7h2v2H6zM6 11h2v2H6zM6 15h2v2H6z" />
            </svg>
        </a>
    </div>
